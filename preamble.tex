...
%  Establecer espacio de separación entre columnas
\setlength{\columnsep}{1cm}

% Línea entre columnas, por defecto no se muestra (=0)
% Se recomienda 0.4pt para que sea igual que la \HRuleGray
...
% Redefinir \tag no explícito para que utilice el color main automáticamente
\let\oldtag\tag
\renewcommand{\tag}[1]{\oldtag{\textcolor{main}{#1}}}

% --- Código para cambiar el color del \tag{} explícito---
\makeatletter
\renewcommand{\tagform@}[1]{\maketag@@@{\textcolor{main}{(#1)}}}
\makeatother
